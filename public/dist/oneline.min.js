...
angular.module("Oneline.timelineServices",[]).service("olTimelineHelper",["$q","Timeline","timelineCache","olUI",function(t,e,n,o){var s=Date.now(),i=90,r=18e5;this.initLoad=function(n){var o=t.defer(),s=this;return e.initLoad().$promise.then(function(t){if(t&&!(t.data&&t.data.length<1)){s.storePosts("oldPosts",t,n);var e={data:[],max_id:t.max_id,max_date:t.max_date};s.storePosts("newPosts",e,n),s.checkOldPosts(n).then(function(t){return s.loadOldPosts(t,n)})["finally"](function(){o.resolve()})}}),o.promise},this.initTimelineSettings=function(){s=Date.now(),i=50,n.removeAll()},this.getId=function(t,e){var o,s,i=(n.get(t),"");return"oldPosts"===t?(o="_maxId-",s="_min_id"):(o="_minId-",s="_max_id"),e.forEach(function(t,r){var a=(n.get("oldPosts"),t+o+n.get(t+s)+(r===e.length-1?"":","));i+=a}),i},this.storePosts=function(t,e,o){var s,i,r,a=n.get(t)||[];"oldPosts"===t?(s="min",i="_min_id",r="_min_date"):(s="max",i="_max_id",r="_max_date"),o.forEach(function(t){var o=t+i,a=e[s+"_id"][t],d=t+r,l=e[s+"_date"][t];a&&n.put(o,a),l&&n.put(d,l)}),a=a.concat(e.data),n.put(t,a)},this.checkOldPosts=function(e){return t(function(t,o){var i=e.filter(function(t){return s-n.get(t+"_min_date")<r});i.length>0?t(i):o("all valid")})},this.extractOldPosts=function(t){for(var e,o=n.get("oldPosts")||[],i=!0;i;)e=o.filter(function(t){var e=s-t.created_at;return e>0&&r>=e}),s-=r,e.length>0&&(i=!1);return this.updateOldPostsCount(t),e},this.loadOldPosts=function(n,s){function r(n){var i=t.defer(),r=l.getId("oldPosts",n);return e.load({id:r,count:u}).$promise.then(function(t){return!t||t.data&&t.data.length<1?void i.reject():(t.min_date.twitter&&t.data.splice(0,1),l.storePosts("oldPosts",t,s),100>u?u+=10:null,void i.resolve())},function(t){404===t.status&&o.setLoading(!1,-1)}),i.promise}function a(){var e=t.defer();return l.checkOldPosts(s).then(function(t){r(t).then(a).then(function(){e.resolve()})},function(){e.resolve()}),e.promise}var d=t.defer(),l=this,u=i;return r(n).then(a).then(function(){100>i?i+=10:null,d.resolve()}),d.promise},this.loadNewPosts=function(n){var o=t.defer();return _this=this,e.load({id:_this.getId("newPosts",n),count:70}).$promise.then(function(t){t.data&&t.data.length>0?(_this.storePosts("newPosts",t,n),o.resolve()):o.reject()}),o.promise},this.removeOldPosts=function(t,e){var n=Date.now(),o=t.filter(function(t){return n-t.created_at<2*r});return s=n-2*r,this.updateOldPostsCount(e),o},this.updateOldPostsCount=function(t){this.checkOldPosts(t).then(function(){o.setPostsCount("oldPosts",0)},function(){var t=n.get("oldPosts")||[],e=0;t.forEach(function(t){var n=s-t.created_at;n>0&&r>=n&&e++}),o.setPostsCount("oldPosts",e)})}}]);
...
angular.module("Oneline.timelineControllers",[]).controller("timelineCtrl",["$scope","$state","Timeline","olUI","olTokenHelper","olTimelineHelper","olActionsHelper","timelineCache",function(t,e,i,n,o,s,a,l){return o.isValidToken()?(t.setTimeline(!0),t.timelineData=[],s.initTimelineSettings(),s.initLoad(t.providerList).then(function(){t.timelineData=s.extractOldPosts(t.providerList),n.setLoading(!1,1),n.setLoading(!1,-1)})["catch"](function(t){401===t.status&&e.go("settings")}),t.loadMore=function(i){if(!n.isLoading(i))if(n.setLoading(!0,i),i>0){n.setPostsCount("newPosts",0);var o=l.get("newPosts")||[];if(o.length>1){var a=[];a=t.timelineData.concat(o),t.timelineData=s.removeOldPosts(a,t.providerList),l.put("newPosts",[]),n.setLoading(!1,i),n.setDivider(i)}else s.loadNewPosts(t.providerList).then(function(e){var o=[];o=t.timelineData.concat(l.get("newPosts")||[]),t.timelineData=s.removeOldPosts(o,t.providerList),l.put("newPosts",[]),n.setDivider(i)},function(){})["catch"](function(t){401===t.status&&e.go("settings")})["finally"](function(){n.setLoading(!1,i)})}else s.checkOldPosts(t.providerList).then(function(e){return s.loadOldPosts(e,t.providerList)})["catch"](function(t){console.log(t)})["finally"](function(){var e=s.extractOldPosts(t.providerList);t.timelineData=t.timelineData.concat(e),n.setDivider(i),n.setLoading(!1,i)})},window.intervalLoad&&clearInterval(window.intervalLoad),window.intervalLoad=setInterval(function(){s.loadNewPosts(t.providerList).then(function(){var t=(l.get("newPosts")||[]).length;n.setPostsCount("newPosts",t)},function(){})},18e4),void(t.toggleAction=function(t,e,i){if(!n.isActionWait(t,i)&&!n.isActionFrozen(t,i)){var o=n.isActionActive(t,i);n.setActionState(t,i,"wait"),n.setActionState(t,i,o?"inactive":"active"),a.toggleAction(t,e,i,o)["catch"](function(e){n.setActionState(t,i,o?"active":"inactive")})["finally"](function(){n.setActionState(t,i,"done")})}})):(o.clearToken(),t.updateProviderList(),void e.go("settings"))}]);
