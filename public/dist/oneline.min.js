...
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"=",olSrc:"="},template:'<video ng-attr-poster="{{olPoster}}" preload="none" loop></video>                    <svg class="timeline__media__playButton animate--faster">                        <use xlink:href="/public/img/icon-sprite.svg#play-icon"></use>                    </svg>',link:function(e,n,i){var t=n.children()[0],a=angular.element(n.children()[1]);t.setAttribute("src",e.olSrc),n.bind("click",function(){t.paused?t.play():t.pause(),a.toggleClass("timeline__media__playButton--playing"),n.bind("mouseout",function(){t.removeAttribute("loop")})}),angular.element(t).bind("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,n,i){n.bind("click",function(){var e=n.parent(),t=e.next(),a=e.children(),l=t.children();if(a.removeClass("button--active"),a.addClass("button--inactive"),n.addClass("button--active timeline__media--loading"),e.addClass("timeline__media--small"),t.removeClass("timeline__media--inactive"),l.attr("src",i.src.replace(/square|small/,"bmiddle")),l.bind("load",function(){1===a.length?n.parent().remove():null,n.removeClass("timeline__media--loading"),l.unbind("load")}),!l.data("urlList")){var r=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});l.data("urlList",r)}})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,n,i){i.imageCount>1&&(n.bind("mousemove",function(e){e.offsetX-n[0].offsetWidth/2>0?(n.removeClass("cursor--pre"),n.addClass("cursor--next")):(n.removeClass("cursor--next"),n.addClass("cursor--pre"))}),n.bind("click",function(){var e=n.data("urlList")||[],i=e.indexOf(n.attr("src")),t=n.hasClass("cursor--next")?i+1:i-1;if(!(0>t||t>e.length-1)){var a=angular.element(angular.element(n.parent().parent().children()[0]).children()),l=angular.element(a[t]);n.attr("src",e[t]),a.removeClass("button--active timeline__media--loading"),l.addClass("button--active timeline__media--loading"),n.bind("load",function(){l.removeClass("timeline__media--loading"),n.unbind("load")})}}))}}});
