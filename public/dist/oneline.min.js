angular.module("Oneline",["ngTouch","ngResource","ui.router","angular-jwt","angular-storage","linkify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.timelineServices","Oneline.actionsServices","Oneline.RESTfulServices","Oneline.relativeDateServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.olMediaDirectives","Oneline.trimMediaLinkDirectives"]).config(["$locationProvider","$stateProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider",function(e,t,n,i,r){e.html5Mode(!0),r.tokenGetter=function(){return localStorage.getItem("tokenList")},i.interceptors.push("jwtInterceptor"),n.otherwise("/"),t.state("settings",{url:"/settings",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"})}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]);
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"=",olSrc:"="},template:'<video ng-attr-poster="{{olPoster}}" preload="none"></video>                    <svg class="timeline__media__playButton animate--faster">                        <use xlink:href="/public/img/icon-sprite.svg#play-icon"></use>                    </svg>',link:function(e,i,t){var a=i.children()[0],l=angular.element(i.children()[1]);a.setAttribute("src",e.olSrc),i.bind("click",function(){a.paused?a.play():a.pause(),l.toggleClass("timeline__media__playButton--playing")}),angular.element(a).bind("ended",function(){l.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,i,t){i.bind("click",function(){var e=i.parent(),a=e.next(),l=e.children(),n=a.children();if(1===l.length&&(i.remove(),a.removeClass("timeline__media__large--tips")),l.removeClass("timeline__media__thumb--small--active"),i.addClass("timeline__media__thumb--small--active"),e.addClass("timeline__media__thumb--small"),a.removeClass("timeline__media__large--inactive"),n.attr("src",t.src.replace("square","bmiddle")),!n.data("urlList")){var r=Array.prototype.map.call(l,function(e){return angular.element(e).attr("src").replace("square","bmiddle")});n.data("urlList",r)}})}}}).directive("olImageLarge",function(){return{restrict:"A",link:function(e,i,t){i.bind("click",function(){var e=i.data("urlList")||[],t=e.indexOf(i.attr("src"));if(1!==e.length){var a=angular.element(angular.element(i.parent().parent().children()[0]).children());index=t<e.length-1?t+1:0,target=angular.element(a[index]),i.attr("src",e[index]),a.removeClass("timeline__media__thumb--small--active timeline__media__thumb--small--loading"),target.addClass("timeline__media__thumb--small--active timeline__media__thumb--small--loading"),i.bind("load",function(){target.removeClass("timeline__media__thumb--small--loading"),i.unbind("load")})}})}}});
