...
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,r){function a(){i=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100),e.deckard().$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(i),n.html(e.code)},700),o=setInterval(function(){return 0>t?(a(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(i)})}var i,o;n.bind("$destroy",function(){clearInterval(i),clearInterval(o)}),a()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,r,a){r.bind("submit",function(a){a.preventDefault();var i=r.children(),o=i.val();i[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList()),n.setControlCenter("")},function(e){i.addClass("replicant--rachael--errCode"),setTimeout(function(){i.removeClass("replicant--rachael--errCode")},500)})})}}}]);
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$scope","$timeout","$state","olTokenHelper",function(e,t,o,i){e.providerList=i.getProviderList(),e.isTimeline=!1,e.controlCenter="",e.updateProviderList=function(){t(function(){e.providerList=i.getProviderList()})},e.setTimeline=function(t){e.isTimeline=t},e.setControlCenter=function(t){e.controlCenter=t},e.isAuth=function(t){return e.providerList.indexOf(t)>=0},e["goto"]=function(t,i){if(!("timeline"===t&&e.providerList<=0)){var n=i.target;"img"===n.tagName.toLowerCase()&&angular.element(n).parent().find("img").length>1||o.go(t)}}}]);
