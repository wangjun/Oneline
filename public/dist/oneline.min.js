angular.module("Oneline",["ngTouch","ngResource","ngSanitize","ui.router","angular-jwt","angular-storage","linkify","weibo-emotify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.timelineServices","Oneline.actionsServices","Oneline.RESTfulServices","Oneline.relativeDateServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.olMediaDirectives","Oneline.olTextDirectives","Oneline.olControlCenterDirectives"]).config(["$locationProvider","$stateProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider","weiboEmotifyProvider",function(e,t,n,i,r,o){e.html5Mode(!0),r.tokenGetter=function(){return localStorage.getItem("tokenList")},i.interceptors.push("jwtInterceptor"),n.otherwise("/"),t.state("settings",{url:"/settings",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"}),o.setEmotionsURL("/public/dist/emotions_v1.min.json"),angular.element.prototype.addClassTemporarily=function(e,t){var n=this;n.addClass(e),setTimeout(function(){n.removeClass(e)},t)}}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]);
angular.module("Oneline.olControlCenterDirectives",[]).directive("toggleClass",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){t.toggleClass(n.toggleClass)})}}}).directive("toggleIcon",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){var e=n.toggleIcon.split(","),r=t.find("use"),i=0==e.indexOf(r.attr("xlink:href"))?e[1].trim():e[0].trim();r.attr("xlink:href",i)})}}}).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,r){function i(){a=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100),e.deckard().$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(a),n.html(e.code)},700),o=setInterval(function(){return 0>t?(i(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(a)})}var a,o;n.on("$destroy",function(){clearInterval(a),clearInterval(o)}),i()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,r,i){r.on("submit",function(i){i.preventDefault();var a=r.children(),o=a.val();a[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList()),n.setControlCenter(""),n.toggleActive({currentTarget:document.querySelector(".replicant-icon--rachael")})},function(e){a.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("writeTweet",["$timeout","Action",function(e,t){return{restrict:"A",scope:!1,link:function(n,r,i){var a=angular.element(document.querySelector(".write__btn--send")),o=r.find("textarea");setTimeout(function(){r.find("textarea")[0].focus()},700);var l="";r.on("submit",function(n){n.preventDefault();var i=r.find("geo-picker").data("geo"),d=r.find("media-upload").data("media_ids");o.prop("disabled",!0),a.addClass("write__btn--send--sending"),t.update({action:"tweet",provider:"twitter",id:0},{params:{status:l,geo:i,media_ids:d}}).$promise.then(function(t){e(function(){angular.element(document.querySelector("[js-newTweet]")).triggerHandler("click")})})["catch"](function(e){a.prop("disabled",!1),o.addClassTemporarily("write__textarea--err",500)})["finally"](function(){o.prop("disabled",!1),a.removeClass("write__btn--send--sending")})}).on("input",function(){l=o.val().trim();var e=l.length;e>140||0===e?a.prop("disabled",!0):a.prop("disabled",!1),a.attr("data-count",e>0?e:""),a.addClassTemporarily("write__btn--send--typing",700)}).on("$destroy",function(){r.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/geoPicker.html",link:function(t,n,r){var i=n.find("button"),a=angular.element(document.querySelector(".write__btn--send")),o=angular.element(document.querySelector(".write__textarea"));i.on("click",function(){i.hasClass("tips--active")?(n.removeData("geo"),i.removeClass("tips--active tips--inprocess")):(i.addClass("tips--inprocess"),a.prop("disabled",!0),o.prop("disabled",!0),e.navigator.geolocation.getCurrentPosition(function(e){n.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),i.addClass("tips--active"),i.removeClass("tips--inprocess"),a.prop("disabled",!1),o.prop("disabled",!1)},function(e){i.removeClass("tips--inprocess"),i.addClassTemporarily("tips--error",500),a.prop("disabled",!1),o.prop("disabled",!1)},{maximumAge:6e4,timeout:7e3}))}),i.on("$destroy",function(){i.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/mediaUpload.html",link:function(t,n,r){function i(e,t){var r=new FileReader;r.onload=function(e){var n=angular.element(document.querySelectorAll(".write__previews")),r='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+e.target.result+'"></span>';n.append(r);var i=document.querySelectorAll(".write__previews__item"),a=angular.element(i[i.length-1]);a.attr("data-mediaId",t)},r.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&n.css("display","none")}function a(e){var t=document.querySelector('[data-mediaId="'+e+'"]');angular.element(t).remove()}function o(e,t){var r=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));r.removeClass("tips--inprocess").attr("data-mediaId",t).on("click",function(){var e=n.data("media_ids")||[],t=r.attr("data-mediaId"),i=e.indexOf(t);e.splice(i,1),e.length<=0?n.removeData("media_ids"):n.data("media_ids",e),r.remove(),document.querySelectorAll(".write__previews__item").length<4&&n.attr("style","")}).on("$destroy",function(){r.off("click")})}var l=n.find("input"),d=angular.element(document.querySelector(".write__btn--send")),c=angular.element(document.querySelector(".write__textarea"));l.on("change",function(){var t=new FormData,r=l[0].files[0];d.prop("disabled",!0),c.prop("disabled",!0);var s=Date.now();i(r,s),t.append("twitterMedia",r),e.upload({provider:"twitter"},t).$promise.then(function(e){var t=n.data("media_ids")||[],r=e.media_id;t.push(r),n.data("media_ids",t),o(s,r)})["catch"](function(e){a(s)})["finally"](function(){d.prop("disabled",!1),c.prop("disabled",!1)}),l[0].value=""}),l.on("$destroy",function(){l.off("change")})}}}]);
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"=",olSrc:"="},templateUrl:"media/video.html",link:function(e,t,n){var r=t.children()[0],a=angular.element(t.children()[1]);r.setAttribute("src",e.olSrc),t.on("click",function(){r.paused?r.play():r.pause(),a.toggleClass("timeline__media__playButton--playing"),t.on("mouseout",function(){r.removeAttribute("loop")})}),angular.element(r).on("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){var e=t.parent(),r=e.next(),a=e.children(),i=r.find("img"),l=r.find("a");if(a.removeClass("button--active"),a.addClass("button--inactive"),t.addClass("button--active timeline__media--loading"),e.addClass("timeline__media--small"),r.removeClass("timeline__media--inactive"),i.attr("src",n.src.replace(/square|small/,"bmiddle")),l.attr("href",n.src.replace(/square|small/,"large")),i.on("load",function(){1===a.length?t.parent().remove():null,t.removeClass("timeline__media--loading"),i.off("load")}),!i.data("urlList")){var o=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});i.data("urlList",o)}})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,t,n){n.imageCount>1&&(t.on("mousemove",function(e){e.offsetX-t[0].offsetWidth/2>0?(t.removeClass("cursor--pre"),t.addClass("cursor--next")):(t.removeClass("cursor--next"),t.addClass("cursor--pre"))}),t.on("click",function(){var e=t.data("urlList")||[],n=e.indexOf(t.attr("src")),r=t.hasClass("cursor--next")?n+1:n-1;if(!(0>r||r>e.length-1)){var a=angular.element(angular.element(t.parent().parent().children()[0]).children()),i=angular.element(a[r]);t.attr("src",e[r]),t.next().attr("href",e[r].replace("bmiddle","large")),a.removeClass("button--active timeline__media--loading"),i.addClass("button--active timeline__media--loading"),t.on("load",function(){i.removeClass("timeline__media--loading"),t.off("load")})}}))}}}).directive("handleImageError",function(){return{restrict:"A",link:function(e,t,n){t.on("error",function(){""!==t.attr("src")&&t.attr("src",'data:image/svg+xml;utf8,<svg viewBox="0 0 529 530" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M51.245 150.775c-3.454-1.729-5.458-.098-4.476 3.638l.706 2.688c8.01 30.498-2.986 73.86-24.566 96.854l-.662.706c-2.643 2.816-1.649 5.288 2.193 5.52l136.636 8.237c9.376.565 23.953-2.031 32.554-5.798l21.279-9.319-13.768-18.801c-5.55-7.579-16.851-17.127-25.254-21.333l-124.642-62.392z" fill="#000"/><path d="M9.298 290.938c13.001 129.203 122.073 230.062 254.702 230.062 141.385 0 256-114.615 256-256s-114.615-256-256-256c-84.794 0-159.96 41.226-206.547 104.728" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/><path d="M361.259 190.733c-4.06-1.129-8.339-1.733-12.759-1.733-26.234 0-47.5 21.266-47.5 47.5 0 4.115.523 8.109 1.507 11.917" stroke="#000" stroke-width="17" stroke-linecap="round"/><path d="M213.468 406.97c13.141-16.776 37.347-28.026 65.032-28.026 30.37 0 56.552 13.538 68.536 33.056" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/></g></svg>')})}}});
...
angular.module("Oneline.RESTfulServices",[]).factory("Timeline",["$resource",function(e){return e("/timeline/:id/:count",null,{initLoad:{method:"GET"},load:{method:"GET"}})}]).factory("Action",["$resource",function(e){return e("/actions/:action/:provider/:id",null,{create:{method:"PUT",params:{action:"@action",provider:"@provider",id:"@id"}},destroy:{method:"DELETE"},update:{method:"POST"}})}]).factory("Auth",["$resource",function(e){return e("/auth/revoke/:provider",null,{revoke:{method:"DELETE"}})}]).factory("Replicant",["$resource",function(e){return e("/auth/replicant/:replicant",null,{deckard:{method:"GET",params:{replicant:"deckard"}},rachael:{method:"POST",params:{replicant:"rachael"}}})}]).factory("Media",["$resource",function(e){return e("/upload/:provider",null,{upload:{method:"POST",transformRequest:angular.identity,headers:{"Content-Type":void 0}}})}]);
angular.module("Oneline.UIServices",[]).service("olUI",["$filter",function(t){this.updateSocialIcon=function(t){var a={twitter:"#2AA9E0",instagram:"#3F5D87",weibo:"#E6162D"},e=["twitter","instagram","weibo"];e.forEach(function(e){var i=document.querySelectorAll('[data-provider="'+e+'"]'),o=angular.element(i[0]),n=angular.element(i[1]);t.indexOf(e)>=0?(o.attr("fill",a[e]),n.addClass("social-icon--active tips--active")):(o.attr("fill","#FFF"),n.removeClass("social-icon--active tips--active"))})},this.setLoading=function(t,a){var e=angular.element(document.getElementsByClassName("loadMore")[1===a?0:1]);"start"===t?(e.removeClass("loadMore--loading--fail"),e.addClass("loadMore--loading")):"done"===t?e.removeClass("loadMore--initLoad loadMore--loading loadMore--loading--fail"):"fail"===t&&e.addClass("loadMore--loading loadMore--loading--fail")},this.isLoading=function(t){var a=angular.element(document.getElementsByClassName("loadMore")[1===t?0:1]);return a.hasClass("loadMore--loading")&&!a.hasClass("loadMore--loading--fail")||a.hasClass("loadMore--initLoad")},this.setDivider=function(a){var e=document.querySelectorAll(".timeline:not(.timeline--quote)");e=angular.element(e[1===a?0:e.length-1]),e.attr("data-date",t("date")(Date.now(),"HH:mm")).addClass(1===a?"divider divider--top":"divider divider--bottom")},this.setPostsCount=function(t,a){var e="newPosts"===t;if(e&&a%1===0){var i=(~~a).toString().split(""),o={0:"⁰",1:"¹",2:"²",3:"³",4:"⁴",5:"⁵",6:"⁶",7:"⁷",8:"⁸",9:"⁹"};__msg="",""!==a&&i.forEach(function(t){__msg+=o[t]}),document.title="｜"+__msg}document.getElementsByClassName("loadMore__count")[e?0:1].setAttribute("data-count",a)};var a=function(t,a){return angular.element(document.querySelector('[data-id="'+a+'"]').querySelector("[data-"+t+"]"))};this.setActionState=function(t,e,i){var o=a(t,e);switch(i){case"wait":o.addClass("actions__button--wait");break;case"done":o.removeClass("actions__button--wait");break;case"active":o.addClass("actions__button--active"),o.parent().addClass("tips--active");break;case"inactive":o.removeClass("actions__button--active"),o.parent().removeClass("tips--active")}},this.isActionActive=function(t,e){var i=a(t,e);return i.hasClass("actions__button--active")},this.isActionWait=function(t,e){var i=a(t,e);return i.hasClass("actions__button--wait")},this.isActionFrozen=function(t,e){var i=a(t,e);return i.parent().hasClass("tips--frozen")},this.actionData=function(t,e,i,o){var n,s=a(t,e);return"count"===o?(s=s.next(),n="data-count"):n="data-"+t,i||""===i?void s.attr(n,i):s.attr(n)}}]);
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$rootScope","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,o,n,i,r,l){t.providerList=i.getProviderList(),t.isTimeline=!1,t.controlCenter="",t.updateProviderList=function(){var e=i.getProviderList();o(function(){t.providerList=e,r.updateSocialIcon(e)})},t.setControlCenter=function(e){t.controlCenter=e},t["goto"]=function(e,o){if(!("timeline"===e&&t.providerList<=0)){var i=o.target;"img"===i.tagName.toLowerCase()&&angular.element(i).parent().find("img").length>1||n.go(e)}},t.toggleControlCenter=function(e){t.controlCenter=t.controlCenter===e?"":e},e.$on("$stateChangeSuccess",function(e,o,r,a,s){"timeline"===o.name?i.isValidToken()?t.isTimeline=!0:n.go("settings"):"settings"===o.name&&(i.isValidToken()||i.clearToken(),t.isTimeline=!1),document.title="｜",l.removeAll(),t.updateProviderList(),t.controlCenter=""})}]);
