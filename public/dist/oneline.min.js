...
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"=",olSrc:"="},template:'<video ng-attr-poster="{{olPoster}}" preload="none" loop webkit-playsinline="true"></video>                    <svg class="timeline__media__playButton animate--faster">                        <use xlink:href="/public/img/icon-sprite.svg#play-icon"></use>                    </svg>',link:function(e,t,i){var n=t.children()[0],a=angular.element(t.children()[1]);n.setAttribute("src",e.olSrc),t.bind("click",function(){n.paused?n.play():n.pause(),a.toggleClass("timeline__media__playButton--playing"),t.bind("mouseout",function(){n.removeAttribute("loop")})}),angular.element(n).bind("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,i){t.bind("click",function(){var e=t.parent(),n=e.next(),a=e.children(),l=n.find("img"),r=n.find("a");if(a.removeClass("button--active"),a.addClass("button--inactive"),t.addClass("button--active timeline__media--loading"),e.addClass("timeline__media--small"),n.removeClass("timeline__media--inactive"),l.attr("src",i.src.replace(/square|small/,"bmiddle")),r.attr("href",i.src.replace(/square|small/,"large")),l.bind("load",function(){1===a.length?t.parent().remove():null,t.removeClass("timeline__media--loading"),l.unbind("load")}),!l.data("urlList")){var s=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});l.data("urlList",s)}})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,t,i){i.imageCount>1&&(t.bind("mousemove",function(e){e.offsetX-t[0].offsetWidth/2>0?(t.removeClass("cursor--pre"),t.addClass("cursor--next")):(t.removeClass("cursor--next"),t.addClass("cursor--pre"))}),t.bind("click",function(){var e=t.data("urlList")||[],i=e.indexOf(t.attr("src")),n=t.hasClass("cursor--next")?i+1:i-1;if(!(0>n||n>e.length-1)){var a=angular.element(angular.element(t.parent().parent().children()[0]).children()),l=angular.element(a[n]);t.attr("src",e[n]),t.next().attr("href",e[n].replace("bmiddle","large")),a.removeClass("button--active timeline__media--loading"),l.addClass("button--active timeline__media--loading"),t.bind("load",function(){l.removeClass("timeline__media--loading"),t.unbind("load")})}}))}}});
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$scope","$timeout","$state","olTokenHelper",function(e,o,t,i){e.providerList=i.getProviderList(),e.isTimeline=!1,e.controlCenter="",e.updateProviderList=function(){o(function(){e.providerList=i.getProviderList()})},e.setTimeline=function(o){e.isTimeline=o},e.setControlCenter=function(o){e.controlCenter=o},e.isAuth=function(o){return e.providerList.indexOf(o)>=0},e["goto"]=function(o){"timeline"===o&&e.providerList<=0||t.go(o)}}]);
