...
angular.module("Oneline.timelineControllers",[]).controller("timelineCtrl",["$scope","$state","$stateParams","store","Timeline","olTokenHelper",function(e,i,t,n,r,l){function o(e){n.set("timelineProvider",e),i.go("timeline",{provider:e})}l.isValidToken()?null:i.go("settings",{settings:"settings"}),e.setTimeline(!0),e.providerList.indexOf(t.provider)>=0||"all"===t.provider?o(t.provider):i.go("timeline",{provider:n.get("timelineProvider")}),e.timelineData=[],r.query(function(i){e.timelineData=i})}]);
