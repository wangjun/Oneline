...
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"=",olSrc:"="},template:'<video ng-attr-poster="{{olPoster}}" preload="none" loop></video>                    <svg class="timeline__media__playButton animate--faster">                        <use xlink:href="/public/img/icon-sprite.svg#play-icon"></use>                    </svg>',link:function(e,t,i){var n=t.children()[0],a=angular.element(t.children()[1]);n.setAttribute("src",e.olSrc),t.bind("click",function(){n.paused?n.play():n.pause(),a.toggleClass("timeline__media__playButton--playing"),t.bind("mouseout",function(){n.removeAttribute("loop")})}),angular.element(n).bind("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,i){t.bind("click",function(){var e=t.parent(),n=e.next(),a=e.children(),l=n.children();if(1===a.length&&(t.addClass("timeline__media--loading"),l.bind("load",function(){t.remove(),n.removeClass("cursor--next"),l.unbind("load")})),a.removeClass("button--active"),a.addClass("button--inactive"),t.addClass("button--active"),e.addClass("timeline__media--small"),n.removeClass("timeline__media--inactive"),l.attr("src",i.src.replace("square","bmiddle")),!l.data("urlList")){var r=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace("square","bmiddle")});l.data("urlList",r)}})}}}).directive("olImageLarge",function(){return{restrict:"A",link:function(e,t,i){t.bind("click",function(){var e=t.data("urlList")||[],i=e.indexOf(t.attr("src"));if(1!==e.length){var n=angular.element(angular.element(t.parent().parent().children()[0]).children());index=i<e.length-1?i+1:0,target=angular.element(n[index]),t.attr("src",e[index]),n.removeClass("button--active timeline__media--loading"),target.addClass("button--active timeline__media--loading"),t.bind("load",function(){target.removeClass("timeline__media--loading"),t.unbind("load")})}})}}});
