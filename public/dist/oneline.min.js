...
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,r){function a(){i=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100),e.deckard().$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(i),n.html(e.code)},700),o=setInterval(function(){return 0>t?(a(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(i)})}var i,o;n.on("$destroy",function(){clearInterval(i),clearInterval(o)}),a()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,r,a){r.on("submit",function(a){a.preventDefault();var i=r.children(),o=i.val();i[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList()),n.setControlCenter(""),n.toggleActive({currentTarget:document.querySelector(".replicant-icon--rachael")})},function(e){i.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("writeTweet",["$timeout","Action",function(e,t){return{restrict:"A",scope:!1,link:function(e,n,r){var a=angular.element(document.querySelector(".write__btn--send")),i=n.find("textarea");setTimeout(function(){n.find("textarea")[0].focus()},700);var o="";n.on("submit",function(r){r.preventDefault();var d=n.find("geo-picker").data("geo"),l=n.find("media-upload").data("media_ids");i.prop("disabled",!0),a.addClass("write__btn--send--sending"),t.update({action:"tweet",provider:"twitter",id:0},{params:{status:o,geo:d,media_ids:l}}).$promise.then(function(){e.setControlCenter("")})["catch"](function(){a.prop("disabled",!1),i.addClassTemporarily("write__textarea--err",500)})["finally"](function(){i.prop("disabled",!1),a.removeClass("write__btn--send--sending")})}).on("input",function(){o=i.val().trim();var e=o.length;e>140||0===e?a.prop("disabled",!0):a.prop("disabled",!1),a.attr("data-count",e>0?e:""),a.addClassTemporarily("write__btn--send--typing",700)}).on("$destroy",function(){n.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/geoPicker.html",link:function(t,n,r){var a=n.find("button"),i=angular.element(document.querySelector(".write__btn--send")),o=angular.element(document.querySelector(".write__textarea"));a.on("click",function(){a.hasClass("tips--active")?(n.removeData("geo"),a.removeClass("tips--active tips--inprocess")):(a.addClass("tips--inprocess"),i.prop("disabled",!0),o.prop("disabled",!0),e.navigator.geolocation.getCurrentPosition(function(e){n.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),a.addClass("tips--active"),a.removeClass("tips--inprocess"),i.prop("disabled",!1),o.prop("disabled",!1)},function(e){a.removeClass("tips--inprocess"),a.addClassTemporarily("tips--error",500),i.prop("disabled",!1),o.prop("disabled",!1)},{maximumAge:6e4,timeout:7e3}))}),a.on("$destroy",function(){a.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/mediaUpload.html",link:function(t,n,r){function a(e,t){var r=new FileReader;r.onload=function(e){var n=angular.element(document.querySelectorAll(".write__previews")),r='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+e.target.result+'"></span>';n.append(r);var a=document.querySelectorAll(".write__previews__item"),i=angular.element(a[a.length-1]);i.attr("data-mediaId",t)},r.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&n.css("display","none")}function i(e){var t=document.querySelector('[data-mediaId="'+e+'"]');angular.element(t).remove()}function o(e,t){var r=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));r.removeClass("tips--inprocess").attr("data-mediaId",t).on("click",function(){var e=n.data("media_ids")||[],t=r.attr("data-mediaId"),a=e.indexOf(t);e.splice(a,1),e.length<=0?n.removeData("media_ids"):n.data("media_ids",e),r.remove(),document.querySelectorAll(".write__previews__item").length<4&&n.attr("style","")}).on("$destroy",function(){r.off("click")})}var d=n.find("input"),l=angular.element(document.querySelector(".write__btn--send")),c=angular.element(document.querySelector(".write__textarea"));d.on("change",function(){var t=new FormData,r=d[0].files[0];l.prop("disabled",!0),c.prop("disabled",!0);var s=Date.now();a(r,s),t.append("twitterMedia",r),e.upload({provider:"twitter"},t).$promise.then(function(e){var t=n.data("media_ids")||[],r=e.media_id;t.push(r),n.data("media_ids",t),o(s,r)})["catch"](function(e){i(s)})["finally"](function(){l.prop("disabled",!1),c.prop("disabled",!1)}),d[0].value=""}),d.on("$destroy",function(){d.off("change")})}}}]);
...
angular.module("Oneline.UIServices",[]).service("olAnimate",["$q",function(a){this.enter=function(t,e,n,i){return a(function(a,e){angular.forEach(t,function(a){a=angular.element(a);var t=a.hasClass("animate--general")?700:a.hasClass("animate--faster")?300:0;a.addClassTemporarily("ol-enter",t),setTimeout(function(){a.addClassTemporarily("ol-enter--active",t)})}),a()})},this.leave=function(t,e){return a(function(a,e){var n=0;angular.forEach(t,function(t){if(t=angular.element(t),t.hasClass("animate--general")||t.hasClass("animate--faster")){var e=t.hasClass("animate--general")?700:t.hasClass("animate--faster")?300:0;t.addClass("ol-leave"),setTimeout(function(){t.addClass("ol-leave--active")}),setTimeout(function(){t.removeClass("ol-leave--active ol-leave"),a()},e)}else n++}),t.length===n&&a()})}}]).service("olUI",["$filter",function(a){this.updateSocialIcon=function(a){var t={twitter:"#2AA9E0",instagram:"#3F5D87",weibo:"#E6162D"},e=["twitter","instagram","weibo"];e.forEach(function(e){var n=document.querySelectorAll('[data-provider="'+e+'"]'),i=angular.element(n[0]),o=angular.element(n[1]);a.indexOf(e)>=0?(i.attr("fill",t[e]),o.addClass("social-icon--active tips--active")):(i.attr("fill","#FFF"),o.removeClass("social-icon--active tips--active"))})},this.setLoading=function(a,t){var e=angular.element(document.getElementsByClassName("loadMore")[1===t?0:1]);"start"===a?(e.removeClass("loadMore--loading--fail"),e.addClass("loadMore--loading")):"done"===a?e.removeClass("loadMore--initLoad loadMore--loading loadMore--loading--fail"):"fail"===a&&e.addClass("loadMore--loading loadMore--loading--fail")},this.isLoading=function(a){var t=angular.element(document.getElementsByClassName("loadMore")[1===a?0:1]);return t.hasClass("loadMore--loading")&&!t.hasClass("loadMore--loading--fail")||t.hasClass("loadMore--initLoad")},this.setDivider=function(t){var e=document.querySelectorAll(".timeline:not(.timeline--quote)");e=angular.element(e[1===t?0:e.length-1]),e.attr("data-date",a("date")(Date.now(),"HH:mm")).addClass(1===t?"divider divider--top":"divider divider--bottom")},this.setPostsCount=function(a,t){var e="newPosts"===a;if(e&&t%1===0){var n=(~~t).toString().split(""),i={0:"⁰",1:"¹",2:"²",3:"³",4:"⁴",5:"⁵",6:"⁶",7:"⁷",8:"⁸",9:"⁹"};__msg="",""!==t&&n.forEach(function(a){__msg+=i[a]}),document.title="｜"+__msg}document.getElementsByClassName("loadMore__count")[e?0:1].setAttribute("data-count",t)};var t=function(a,t){return angular.element(document.querySelector('[data-id="'+t+'"]').querySelector("[data-"+a+"]"))};this.setActionState=function(a,e,n){var i=t(a,e);switch(n){case"wait":i.addClass("actions__button--wait");break;case"done":i.removeClass("actions__button--wait");break;case"active":i.addClass("actions__button--active"),i.parent().addClass("tips--active");break;case"inactive":i.removeClass("actions__button--active"),i.parent().removeClass("tips--active")}},this.isActionActive=function(a,e){var n=t(a,e);return n.hasClass("actions__button--active")},this.isActionWait=function(a,e){var n=t(a,e);return n.hasClass("actions__button--wait")},this.isActionFrozen=function(a,e){var n=t(a,e);return n.parent().hasClass("tips--frozen")},this.actionData=function(a,e,n,i){var o,s=t(a,e);return"count"===i?(s=s.next(),o="data-count"):o="data-"+a,n||""===n?void s.attr(o,n):s.attr(o)}}]);
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$rootScope","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,o,n,r,i,l){t.providerList=r.getProviderList(),t.isTimeline=!1,t.controlCenter="",t.updateProviderList=function(){var e=r.getProviderList();o(function(){t.providerList=e,i.updateSocialIcon(e)})},t.setControlCenter=function(e){t.controlCenter=e},t["goto"]=function(e,o){var r=n.current.name;if("left"===e){if(t.providerList<=0)return;"settings"===r?n.go("timeline"):t.toggleControlCenter("newTweet")}else"timeline"===r?"newTweet"===t.controlCenter?t.toggleControlCenter("newTweet"):n.go("settings"):null},t.toggleControlCenter=function(e){t.controlCenter=t.controlCenter===e?"":e},e.$on("$stateChangeSuccess",function(e,o,i,s,c){"timeline"===o.name?r.isValidToken()?t.isTimeline=!0:n.go("settings"):"settings"===o.name&&(r.isValidToken()||r.clearToken(),t.isTimeline=!1),document.title="｜",l.removeAll(),t.updateProviderList(),t.controlCenter=""})}]);
