angular.module("Oneline",["ngTouch","ngResource","ngSanitize","ui.router","angular-jwt","angular-storage","linkify","weibo-emotify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.timelineServices","Oneline.actionsServices","Oneline.RESTfulServices","Oneline.relativeDateServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.olMediaDirectives","Oneline.olTextDirectives","Oneline.olControlCenterDirectives"]).config(["$locationProvider","$stateProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider","weiboEmotifyProvider",function(e,t,n,i,r,o){e.html5Mode(!0),r.tokenGetter=function(){return localStorage.getItem("tokenList")},i.interceptors.push("jwtInterceptor"),n.otherwise("/"),t.state("settings",{url:"/settings",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"}),o.setEmotionsURL("/public/dist/emotions_v1.min.json")}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]).run(["$q",function(e){angular.element.prototype.addClassTemporarily=function(e,t){var n=this;return n.addClass(e),setTimeout(function(){n.removeClass(e)},t),this},angular.element.prototype.delay=function(t){return e(function(e,n){setTimeout(function(){e()},t)})}}]);
angular.module("Oneline.olControlCenterDirectives",[]).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,r){function a(){i=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100),e.deckard().$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(i),n.html(e.code)},700),o=setInterval(function(){return 0>t?(a(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(i)})}var i,o;n.on("$destroy",function(){clearInterval(i),clearInterval(o)}),a()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,r,a){r.on("submit",function(a){a.preventDefault();var i=r.children(),o=i.val();i[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList()),n.setControlCenter(""),n.toggleActive({currentTarget:document.querySelector(".replicant-icon--rachael")})},function(e){i.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("write",["$window","Action","olUI",function(e,t,n){return{restrict:"A",scope:!1,link:function(r,a,i){var o,l=r.controlCenter.split(":"),c=l[1],d=l[0].split("-")[1],s="",u="tweet"===d||"reply"===d?140:"retweet"===d?116:null,p=angular.element(e),m=a.find("button"),f=m.eq(m.length-1),v=a.find("textarea");("reply"===d||"retweet"===d)&&("reply"===d?v.val("@"+l[2]+" "):"retweet"===d&&(v.prop("required",!1),f.prop("disabled",!1)),angular.element(document.querySelector(".cancelMask__wrapper")).children().append(angular.element(document.querySelector('[data-id="'+c+'"]')).clone().removeClass("divider--top divider--bottom")),angular.element(document.querySelector(".cancelMask__wrapper").querySelectorAll("button.tips--deep")).addClass("tips--frozen"),angular.element(document.querySelector(".cancelMask__wrapper [data-source]")).parent().removeClass("tips--frozen"),o=angular.element(document.querySelector(".cancelMask__wrapper [data-"+d+"]")),o.parent().removeClass("tips--deep tips--frozen"));var g="";a.on("submit",function(e){e.preventDefault();var i={status:g,geo:a.find("geo-picker").data("geo"),media_ids:a.find("media-upload").data("media_ids")};"retweet"===d&&g.length>0&&(s="quote",angular.extend(i,{status:g+" https://twitter.com/"+l[2]+"/status/"+c})),v.prop("disabled",!0),f.addClass("write__btn--send--sending"),t.update({action:s||d,provider:"twitter",id:c||0},{params:i}).$promise.then(function(e){"retweet"===d&&(n.setActionState("retweet",c,"active"),n.actionData("retweet",c,e.id_str),"quote"===s&&n.setActionState("retweet",c,"frozen")),r.setControlCenter("")})["catch"](function(){f.prop("disabled",!1),v.addClassTemporarily("write__textarea--err",500)})["finally"](function(){v.prop("disabled",!1),f.removeClass("write__btn--send--sending")})}).on("input",function(){g=v.val().trim();var e=g.length;e>u||0===e?f.prop("disabled",!0):f.prop("disabled",!1),f.attr("data-count",e>0?e:""),f.addClassTemporarily("write__btn--send--typing",700),o?o.addClassTemporarily("actions__button--"+d+"--active",300):null}).on("$destroy",function(){a.off(),p.off()}),p.on("keydown",function(e){27===e.keyCode&&r.$apply(function(){r.setControlCenter("")})})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/geoPicker.html",link:function(t,n,r){var a=n.find("button");a.on("click",function(){a.hasClass("tips--active")?(n.removeData("geo"),a.removeClass("tips--active tips--inprocess")):(a.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){n.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),a.addClass("tips--active"),a.removeClass("tips--inprocess")},function(e){a.removeClass("tips--inprocess"),a.addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}),a.on("$destroy",function(){a.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/mediaUpload.html",link:function(t,n,r){function a(e,t){var r=new FileReader;r.onload=function(e){var n=angular.element(document.querySelectorAll(".write__previews")),r='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+e.target.result+'"></span>';n.append(r);var a=document.querySelectorAll(".write__previews__item"),i=angular.element(a[a.length-1]);i.attr("data-mediaId",t)},r.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&n.css("display","none")}function i(e){var t=document.querySelector('[data-mediaId="'+e+'"]');angular.element(t).remove()}function o(e,t){var r=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));r.removeClass("tips--inprocess").attr("data-mediaId",t).on("click",function(){var e=n.data("media_ids")||[],t=r.attr("data-mediaId"),a=e.indexOf(t);e.splice(a,1),e.length<=0?n.removeData("media_ids"):n.data("media_ids",e),r.remove(),document.querySelectorAll(".write__previews__item").length<4&&n.attr("style","")}).on("$destroy",function(){r.off("click")})}var l=n.find("input");l.on("change",function(){var t=new FormData,r=l[0].files[0],c=Date.now();a(r,c),t.append("twitterMedia",r),e.upload({provider:"twitter"},t).$promise.then(function(e){var t=n.data("media_ids")||[],r=e.media_id;t.push(r),n.data("media_ids",t),o(c,r)})["catch"](function(e){i(c)}),l[0].value=""}),l.on("$destroy",function(){l.off("change")})}}}]);
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"=",olSrc:"="},templateUrl:"media/video.html",link:function(e,t,i){var n=t.children()[0],a=angular.element(t.children()[1]);n.setAttribute("src",e.olSrc),t.on("click",function(){n.paused?n.play():n.pause(),a.toggleClass("timeline__media__playButton--playing"),t.on("mouseout",function(){n.removeAttribute("loop")})}),angular.element(n).on("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,i){t.on("click",function(){var e=t.parent(),n=e.next(),a=e.children(),r=n.find("img"),l=n.find("a");if(a.removeClass("timeline__media--active"),a.addClass("timeline__media--inactive"),t.addClass("timeline__media--active timeline__media--loading"),e.addClass("timeline__media--small"),n.removeClass("timeline__media--hide"),r.attr("src",i.src.replace(/square|small/,"bmiddle")),l.attr("href",i.src.replace(/square|small/,"large")),r.on("load",function(){1===a.length?t.parent().remove():null,t.removeClass("timeline__media--loading"),r.off("load")}),!r.data("urlList")){var o=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace(/square|small/,"bmiddle")});r.data("urlList",o)}})}}}).directive("selectImage",function(){return{restrict:"A",link:function(e,t,i){i.imageCount>1&&(t.on("mousemove",function(e){e.offsetX-t[0].offsetWidth/2>0?(t.removeClass("cursor--pre"),t.addClass("cursor--next")):(t.removeClass("cursor--next"),t.addClass("cursor--pre"))}),t.on("click",function(){var e=t.data("urlList")||[],i=e.indexOf(t.attr("src")),n=t.hasClass("cursor--next")?i+1:i-1;if(!(0>n||n>e.length-1)){var a=angular.element(angular.element(t.parent().parent().children()[0]).children()),r=angular.element(a[n]);t.attr("src",e[n]),t.next().attr("href",e[n].replace("bmiddle","large")),a.removeClass("timeline__media--active timeline__media--loading"),r.addClass("timeline__media--active timeline__media--loading"),t.on("load",function(){r.removeClass("timeline__media--loading"),t.off("load")})}}))}}}).directive("handleImageError",function(){return{restrict:"A",link:function(e,t,i){t.on("error",function(){""!==t.attr("src")&&t.attr("src",'data:image/svg+xml;utf8,<svg viewBox="0 0 529 530" xmlns="http://www.w3.org/2000/svg"><g fill="none"><path d="M51.245 150.775c-3.454-1.729-5.458-.098-4.476 3.638l.706 2.688c8.01 30.498-2.986 73.86-24.566 96.854l-.662.706c-2.643 2.816-1.649 5.288 2.193 5.52l136.636 8.237c9.376.565 23.953-2.031 32.554-5.798l21.279-9.319-13.768-18.801c-5.55-7.579-16.851-17.127-25.254-21.333l-124.642-62.392z" fill="#000"/><path d="M9.298 290.938c13.001 129.203 122.073 230.062 254.702 230.062 141.385 0 256-114.615 256-256s-114.615-256-256-256c-84.794 0-159.96 41.226-206.547 104.728" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/><path d="M361.259 190.733c-4.06-1.129-8.339-1.733-12.759-1.733-26.234 0-47.5 21.266-47.5 47.5 0 4.115.523 8.109 1.507 11.917" stroke="#000" stroke-width="17" stroke-linecap="round"/><path d="M213.468 406.97c13.141-16.776 37.347-28.026 65.032-28.026 30.37 0 56.552 13.538 68.536 33.056" stroke="#000" stroke-width="17" stroke-linecap="round" stroke-linejoin="round"/></g></svg>')})}}});
...
angular.module("Oneline.UIServices",[]).service("olAnimate",["$q",function(a){this.enter=function(e,t,n,i){return a(function(a,t){angular.forEach(e,function(a){a=angular.element(a);var e=a.hasClass("animate--general")?700:a.hasClass("animate--faster")?300:0;a.addClassTemporarily("ol-enter",e).delay(70).then(function(){a.addClassTemporarily("ol-enter--active",e)})}),a()})},this.leave=function(e,t){return a(function(a,t){var n=0;angular.forEach(e,function(e){if(e=angular.element(e),e.hasClass("animate--general")||e.hasClass("animate--faster")){var t=e.hasClass("animate--general")?700:e.hasClass("animate--faster")?300:0;e.addClass("ol-leave").delay(70).then(function(){e.addClass("ol-leave--active").delay(t).then(function(){e.removeClass("ol-leave--active ol-leave"),a()})})}else n++}),e.length===n&&a()})}}]).service("olUI",["$filter",function(a){this.updateSocialIcon=function(a){var e={twitter:"#2AA9E0",instagram:"#3F5D87",weibo:"#E6162D"},t=["twitter","instagram","weibo"];t.forEach(function(t){var n=document.querySelectorAll('[data-provider="'+t+'"]'),i=angular.element(n[0]),o=angular.element(n[1]);a.indexOf(t)>=0?(i.attr("fill",e[t]),o.addClass("social-icon--active tips--active")):(i.attr("fill","#FFF"),o.removeClass("social-icon--active tips--active"))})},this.setLoading=function(a,e){var t=angular.element(document.getElementsByClassName("loadMore")[1===e?0:1]);"start"===a?(t.removeClass("loadMore--loading--fail"),t.addClass("loadMore--loading")):"done"===a?t.removeClass("loadMore--initLoad loadMore--loading loadMore--loading--fail"):"fail"===a&&t.addClass("loadMore--loading loadMore--loading--fail")},this.isLoading=function(a){var e=angular.element(document.getElementsByClassName("loadMore")[1===a?0:1]);return e.hasClass("loadMore--loading")&&!e.hasClass("loadMore--loading--fail")||e.hasClass("loadMore--initLoad")},this.setDivider=function(e){var t=document.querySelectorAll(".timeline:not(.timeline--quote)");t=angular.element(t[1===e?0:t.length-1]),t.attr("data-date",a("date")(Date.now(),"HH:mm")).addClass(1===e?"divider divider--top":"divider divider--bottom")},this.setPostsCount=function(a,e){var t="newPosts"===a;if(t&&e%1===0){var n=(~~e).toString().split(""),i={0:"⁰",1:"¹",2:"²",3:"³",4:"⁴",5:"⁵",6:"⁶",7:"⁷",8:"⁸",9:"⁹"};__msg="",""!==e&&n.forEach(function(a){__msg+=i[a]}),document.title="｜"+__msg}document.getElementsByClassName("loadMore__count")[t?0:1].setAttribute("data-count",e)};var e=function(a,e){return angular.element(document.querySelector('[data-id="'+e+'"]').querySelector("[data-"+a+"]"))};this.setActionState=function(a,t,n){var i=e(a,t);switch(n){case"wait":i.addClass("actions__button--wait");break;case"done":i.removeClass("actions__button--wait");break;case"active":i.addClass("actions__button--"+a+"--active"),i.parent().addClass("tips--active");break;case"inactive":i.removeClass("actions__button--"+a+"--active"),i.parent().removeClass("tips--active");break;case"frozen":i.parent().addClass("tips--frozen")}},this.isActionActive=function(a,t){var n=e(a,t);return n.hasClass("actions__button--"+a+"--active")},this.isActionWait=function(a,t){var n=e(a,t);return n.hasClass("actions__button--wait")},this.isActionFrozen=function(a,t){var n=e(a,t);return n.parent().hasClass("tips--frozen")},this.actionData=function(a,t,n,i){var o,s=e(a,t);return"count"===i?(s=s.next(),o="data-count"):o="data-"+a,n||""===n?void s.attr(o,n):s.attr(o)}}]);
...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$rootScope","$scope","$timeout","$state","olTokenHelper","olUI","timelineCache",function(e,t,o,n,i,r,l){t.providerList=i.getProviderList(),t.isTimeline=!1,t.controlCenter="",t.updateProviderList=function(){var e=i.getProviderList();o(function(){t.providerList=e,r.updateSocialIcon(e)})},t.setControlCenter=function(e){t.controlCenter=e},t["goto"]=function(e,o){var i=n.current.name;if("left"===e){if(t.providerList<=0)return;"settings"===i?n.go("timeline"):t.setControlCenter("write-tweet")}else"timeline"===i?t.controlCenter.indexOf("write")>=0?t.setControlCenter(""):n.go("settings"):null},e.$on("$stateChangeSuccess",function(e,o,r,s,c){"timeline"===o.name?i.isValidToken()?t.isTimeline=!0:n.go("settings"):"settings"===o.name&&(i.isValidToken()||i.clearToken(),t.isTimeline=!1),document.title="｜",l.removeAll(),t.updateProviderList(),t.controlCenter=""})}]);
