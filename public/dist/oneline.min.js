...
angular.module("Oneline.rootControllers",[]).controller("rootController",["$scope","$timeout","$state","olTokenHelper",function(e,i,o,t){e.providerList=t.getProviderList(),e.isTimeline=!1,e.updateProviderList=function(){i(function(){e.providerList=t.getProviderList()})},e.setTimeline=function(i){e.isTimeline=i},e.isAuth=function(i){return e.providerList.indexOf(i)>=0},e["goto"]=function(e){o.go(e)}}]);
