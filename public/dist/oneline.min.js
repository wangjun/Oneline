...
angular.module("Oneline.olMediaDirectives",[]).directive("olVideo",function(){return{restrict:"E",scope:{olPoster:"=",olSrc:"="},template:'<video ng-attr-poster="{{olPoster}}" preload="none" loop></video>                    <svg class="timeline__media__playButton animate--faster">                        <use xlink:href="/public/img/icon-sprite.svg#play-icon"></use>                    </svg>',link:function(e,t,n){var i=t.children()[0],a=angular.element(t.children()[1]);i.setAttribute("src",e.olSrc),t.bind("click",function(){i.paused?i.play():i.pause(),a.toggleClass("timeline__media__playButton--playing"),t.bind("mouseout",function(){i.removeAttribute("loop")})}),angular.element(i).bind("ended",function(){a.removeClass("timeline__media__playButton--playing")})}}}).directive("olImageThumb",function(){return{restrict:"A",link:function(e,t,n){t.bind("click",function(){var e=t.parent(),i=e.next(),a=e.children(),l=i.children();if(1===a.length&&(t.addClass("timeline__media--loading"),l.bind("load",function(){t.parent().remove(),i.removeClass("cursor--next"),l.unbind("load")})),a.removeClass("button--active"),a.addClass("button--inactive"),t.addClass("button--active"),e.addClass("timeline__media--small"),i.removeClass("timeline__media--inactive"),l.attr("src",n.src.replace("square","bmiddle")),!l.data("urlList")){var r=Array.prototype.map.call(a,function(e){return angular.element(e).attr("src").replace("square","bmiddle")});l.data("urlList",r)}})}}}).directive("olImageLarge",function(){return{restrict:"A",link:function(e,t,n){t.bind("click",function(){var e=t.data("urlList")||[],n=e.indexOf(t.attr("src"));if(1!==e.length){var i=angular.element(angular.element(t.parent().parent().children()[0]).children());index=n<e.length-1?n+1:0,target=angular.element(i[index]),t.attr("src",e[index]),i.removeClass("button--active timeline__media--loading"),target.addClass("button--active timeline__media--loading"),t.bind("load",function(){target.removeClass("timeline__media--loading"),t.unbind("load")})}})}}});
...
angular.module("Oneline.UIServices",[]).service("olUI",function(){this.setLoading=function(t,e){var a=angular.element(document.getElementsByClassName("loadMore")[1===e?0:1]);t?a.children().addClass("loadMore__loading"):(a.removeClass("loadMore--initLoad"),a.children().removeClass("loadMore__loading"))},this.isLoading=function(t){var e=angular.element(document.getElementsByClassName("loadMore")[1===t?0:1]);return e.children().hasClass("loadMore__loading")},this.setDivider=function(t){var e=document.querySelectorAll(".timeline:not(.timeline--quote)");1===t?angular.element(e[0]).addClass("divider--top"):angular.element(e[e.length-1]).addClass("divider--bottom")},this.setNewPostsCount=function(t){document.getElementsByClassName("loadMore__count")[0].setAttribute("data-count",t)};var t=function(t,e){return angular.element(document.querySelector('[data-id="'+e+'"]').querySelector("[data-"+t+"]"))};this.setActionState=function(e,a,n){var s=t(e,a);switch(n){case"wait":s.addClass("actions__button--wait");break;case"done":s.removeClass("actions__button--wait");break;case"active":s.addClass("actions__button--active"),s.parent().addClass("tips--active");break;case"inactive":s.removeClass("actions__button--active"),s.parent().removeClass("tips--active")}},this.isActionActive=function(e,a){var n=t(e,a);return n.hasClass("actions__button--active")},this.isActionWait=function(e,a){var n=t(e,a);return n.hasClass("actions__button--wait")},this.isActionFrozen=function(e,a){var n=t(e,a);return n.parent().hasClass("tips--frozen")},this.actionData=function(e,a,n){var s=t(e,a);return arguments.length>2&&s.attr("data-"+e,n),s.attr("data-"+e)}});
