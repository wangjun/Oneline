angular.module("Oneline",["ngTouch","ngResource","ui.router","angular-jwt","angular-storage","linkify","Oneline.templates","Oneline.rootControllers","Oneline.settingsControllers","Oneline.timelineControllers","Oneline.timelineServices","Oneline.actionsServices","Oneline.RESTfulServices","Oneline.relativeDateServices","Oneline.tokenHelperServices","Oneline.UIServices","Oneline.olVideoDirectives","Oneline.trimMediaLinkDirectives"]).config(["$locationProvider","$stateProvider","$urlRouterProvider","$httpProvider","jwtInterceptorProvider",function(e,t,n,r,i){e.html5Mode(!0),i.tokenGetter=function(){return localStorage.getItem("tokenList")},r.interceptors.push("jwtInterceptor"),n.otherwise("/"),t.state("settings",{url:"/?s",templateProvider:["$templateCache",function(e){return e.get("settings.html")}],controller:"settingsCtrl"}).state("timeline",{url:"/{provider:all|twitter|instagram|weibo}",templateProvider:["$templateCache",function(e){return e.get("timeline.html")}],controller:"timelineCtrl"})}]).factory("timelineCache",["$cacheFactory",function(e){return e("timelineCache")}]);
...
angular.module("Oneline.UIServices",[]).service("olUI",function(){this.setLoading=function(t,a){var e=angular.element(document.getElementsByClassName("loadMore")[1===a?0:1]);t?e.children().addClass("loadMore__loading"):(e.removeClass("loadMore--initLoad"),e.children().removeClass("loadMore__loading"))},this.isLoading=function(t){var a=angular.element(document.getElementsByClassName("loadMore")[1===t?0:1]);return a.children().hasClass("loadMore__loading")},this.setDivider=function(t){var a=document.getElementsByClassName("timeline");1===t?angular.element(a[0]).addClass("divider--top"):angular.element(a[a.length-1]).addClass("divider--bottom")},this.setNewPostsCount=function(t){document.getElementsByClassName("loadMore__count")[0].setAttribute("data-count",t)};var t=function(t,a){return angular.element(document.querySelector('[data-id="'+a+'"]').querySelector("[data-"+t+"]"))};this.setActionState=function(a,e,n){var s=t(a,e);switch(n){case"wait":s.addClass("actions__button--wait");break;case"done":s.removeClass("actions__button--wait");break;case"active":s.addClass("actions__button--active"),s.parent().addClass("tips--active");break;case"inactive":s.removeClass("actions__button--active"),s.parent().removeClass("tips--active")}},this.isActionActive=function(a,e){var n=t(a,e);return n.hasClass("actions__button--active")},this.isActionWait=function(a,e){var n=t(a,e);return n.hasClass("actions__button--wait")},this.isActionFrozen=function(a,e){var n=t(a,e);return n.parent().hasClass("tips--frozen")},this.actionData=function(a,e,n){var s=t(a,e);return arguments.length>2&&s.attr("data-"+a,n),s.attr("data-"+a)}});
angular.module("Oneline.actionsServices",[]).service("olActionsHelper",["Action","olUI",function(t,e){this.toggleAction=function(n,o,i,a){var c=a?"destroy":"create",r=i;return"retweet"===n&&"destroy"===c&&(i=e.actionData(n,r)),t[c]({action:n,provider:o,id:i}).$promise.then(function(t){if("retweet"===n)if("create"===c)e.actionData(n,r,t.id_str),e.actionData("count",r,t.retweet_count);else{var o=t.retweet_count-1,i=o>0?o:"";e.actionData("count",r,i)}})}}]);
