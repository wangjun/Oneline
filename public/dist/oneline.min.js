...
angular.module("Oneline.olControlCenterDirectives",[]).directive("toggleClass",function(){return{restrict:"A",link:function(t,n,e){n.on("click",function(){n.toggleClass(e.toggleClass)})}}}).directive("toggleIcon",function(){return{restrict:"A",link:function(t,n,e){n.on("click",function(){var t=e.toggleIcon.split(", "),r=n.find("use"),i=0==t.indexOf(r.attr("xlink:href"))?t[1]:t[0];console.log(r.attr("xlink:href"),i),r.attr("xlink:href",i)})}}}).directive("replicantDeckard",["Replicant",function(t){return{restrict:"A",link:function(n,e,r){function i(){o=setInterval(function(){for(var t="";t.length<7;t+=Math.random().toString(36).substr(2));e.html(t.substr(0,7))},100),t.deckard().$promise.then(function(t){var n=60;setTimeout(function(){clearInterval(o),e.html(t.code)},700),c=setInterval(function(){return 0>n?(i(),e.attr("data-countdown",""),void clearInterval(c)):void e.attr("data-countdown",n--)},1e3)},function(t){clearInterval(o)})}var o,c;e.bind("$destroy",function(){clearInterval(o),clearInterval(c)}),i()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(t,n){return{restrict:"A",link:function(e,r,i){r.bind("submit",function(i){i.preventDefault();var o=r.children(),c=o.val();o[0].blur(),t.rachael({code:c}).$promise.then(function(t){t.msg.length>0?t.msg.forEach(function(t){alert(t)}):(n.replaceTokenList(t.tokenList),e.updateProviderList()),e.setControlCenter(""),e.toggleActive({currentTarget:document.querySelector(".replicant-icon--rachael")})},function(t){o.addClass("replicant--rachael--errCode"),setTimeout(function(){o.removeClass("replicant--rachael--errCode")},500)})})}}}]).directive("writeTweet",["Action","olTokenHelper",function(t,n){return{restrict:"A",scope:!1,link:function(n,e,r){var i=e.find("button"),o=e.find("textarea"),c=e.find("span"),l="";e.bind("submit",function(n){n.preventDefault(),console.log(l),t.update({action:"tweet",provider:"twitter",id:0},{status:l}).$promise.then(function(t){},function(t){})}),e.bind("input",function(){l=o.val(),c.html(140-l.length),i.addClass("write__submit__button--typing"),setTimeout(function(){i.removeClass("write__submit__button--typing")},700)}),e.on("$destroy",function(){e.unbind()})}}}]);
