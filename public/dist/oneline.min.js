...
angular.module("Oneline.olControlCenterDirectives",[]).directive("toggleClass",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){t.toggleClass(n.toggleClass)})}}}).directive("toggleIcon",function(){return{restrict:"A",link:function(e,t,n){t.on("click",function(){var e=n.toggleIcon.split(","),i=t.find("use"),r=0==e.indexOf(i.attr("xlink:href"))?e[1].trim():e[0].trim();i.attr("xlink:href",r)})}}}).directive("replicantDeckard",["Replicant",function(e){return{restrict:"A",link:function(t,n,i){function r(){a=setInterval(function(){for(var e="";e.length<7;e+=Math.random().toString(36).substr(2));n.html(e.substr(0,7))},100),e.deckard().$promise.then(function(e){var t=60;setTimeout(function(){clearInterval(a),n.html(e.code)},700),o=setInterval(function(){return 0>t?(r(),n.attr("data-countdown",""),void clearInterval(o)):void n.attr("data-countdown",t--)},1e3)},function(e){clearInterval(a)})}var a,o;n.on("$destroy",function(){clearInterval(a),clearInterval(o)}),r()}}}]).directive("replicantRachael",["Replicant","olTokenHelper",function(e,t){return{restrict:"A",link:function(n,i,r){i.on("submit",function(r){r.preventDefault();var a=i.children(),o=a.val();a[0].blur(),e.rachael({code:o}).$promise.then(function(e){e.msg.length>0?e.msg.forEach(function(e){alert(e)}):(t.replaceTokenList(e.tokenList),n.updateProviderList()),n.setControlCenter(""),n.toggleActive({currentTarget:document.querySelector(".replicant-icon--rachael")})},function(e){a.addClassTemporarily("replicant--rachael--errCode",500)})})}}}]).directive("writeTweet",["$timeout","Action",function(e,t){return{restrict:"A",scope:!1,link:function(n,i,r){var a=angular.element(document.querySelector(".write__btn--send")),o=i.find("textarea"),c="";i.on("submit",function(n){n.preventDefault();var r=i.find("geo-picker").data("geo"),l=i.find("media-upload").data("media_ids");o.prop("disabled",!0),a.addClass("write__btn--send--sending"),t.update({action:"tweet",provider:"twitter",id:0},{params:{status:c,geo:r,media_ids:l}}).$promise.then(function(t){e(function(){angular.element(document.querySelector("[js-newTweet]")).triggerHandler("click")})})["catch"](function(e){a.prop("disabled",!1),o.addClassTemporarily("write__textarea--err",500)})["finally"](function(){o.prop("disabled",!1),a.removeClass("write__btn--send--sending")})}),i.on("input",function(){c=o.val().trim();var e=c.length;e>140||0===e?a.prop("disabled",!0):a.prop("disabled",!1),a.attr("data-count",e>0?e:""),a.addClassTemporarily("write__btn--send--typing",700)}),i.on("$destroy",function(){i.off()})}}}]).directive("geoPicker",["$window",function(e){return{restrict:"E",templateUrl:"controlCenter/write/geoPicker.html",link:function(t,n,i){var r=n.find("button");r.on("click",function(){r.hasClass("tips--active")?(n.data("geo",{}),r.removeClass("tips--active tips--inprocess")):(r.addClass("tips--inprocess"),e.navigator.geolocation.getCurrentPosition(function(e){n.data("geo",{lat:e.coords.latitude,"long":e.coords.longitude}),r.addClass("tips--active"),r.removeClass("tips--inprocess")},function(e){r.removeClass("tips--inprocess"),r.addClassTemporarily("tips--error",500)},{maximumAge:6e4,timeout:7e3}))}),r.on("$destroy",function(){r.off("click")})}}}]).directive("mediaUpload",["Media",function(e){return{restrict:"E",templateUrl:"controlCenter/write/mediaUpload.html",link:function(t,n,i){function r(e,t){var i=new FileReader;i.onload=function(e){var n=angular.element(document.querySelectorAll(".write__previews")),i='<span class="write__previews__item tips--active tips--inprocess animate--faster" data-mediaId><img src="'+e.target.result+'"></span>';n.append(i);var r=document.querySelectorAll(".write__previews__item"),a=angular.element(r[r.length-1]);a.attr("data-mediaId",t)},i.readAsDataURL(e),3===document.querySelectorAll(".write__previews__item").length&&n.css("display","none")}function a(e){var t=document.querySelector('[data-mediaId="'+e+'"]');angular.element(t).remove()}function o(e,t){var i=angular.element(document.querySelector('[data-mediaId="'+e+'"]'));i.removeClass("tips--inprocess").attr("data-mediaId",t).on("click",function(){var e=n.data("media_ids")||[],t=i.attr("data-mediaId"),r=e.indexOf(t);e.splice(r,1),n.data("media_ids",e),i.remove(),document.querySelectorAll(".write__previews__item").length<4&&n.attr("style","")}).on("$destroy",function(){i.off("click")})}var c=n.find("input");c.on("change",function(){var t=new FormData,i=c[0].files[0],l=Date.now();r(i,l),t.append("twitterMedia",i),e.upload({provider:"twitter"},t).$promise.then(function(e){var t=n.data("media_ids")||[],i=e.media_id;t.push(i),n.data("media_ids",t),o(l,i)})["catch"](function(e){a(l)})}),c.on("$destroy",function(){c.off("change")})}}}]);
...
angular.module("Oneline.timelineServices",[]).service("olTimelineHelper",["$q","$state","Timeline","timelineCache","olUI",function(t,e,n,o,s){var i=Date.now(),r=90,a=18e5;this.initLoad=function(e){var o=t.defer(),s=this;return n.initLoad().$promise.then(function(t){if(!t||t.data&&t.data.length<1)return void o.reject({status:304});s.storePosts("oldPosts",t,e);var n={data:[],max_id:t.max_id,max_date:t.max_date};return s.storePosts("newPosts",n,e),s.checkOldPosts(e).then(function(t){return t.length>0?s.loadOldPosts(t,e):void o.resolve()})}).then(function(){o.resolve()})["catch"](function(t){o.reject(t)}),o.promise},this.initTimelineSettings=function(){i=Date.now(),r=50},this.getId=function(t,e){var n,s,i=(o.get(t),"");return"oldPosts"===t?(n="_maxId-",s="_min_id"):(n="_minId-",s="_max_id"),e.forEach(function(t,r){var a=(o.get("oldPosts"),t+n+o.get(t+s)+(r===e.length-1?"":","));i+=a}),i},this.storePosts=function(t,e,n){var s,i,r,a=o.get(t)||[];"oldPosts"===t?(s="min",i="_min_id",r="_min_date"):(s="max",i="_max_id",r="_max_date"),n.forEach(function(t){var n=t+i,a=e[s+"_id"][t],d=t+r,c=e[s+"_date"][t];a&&o.put(n,a),c&&o.put(d,c)}),a=a.concat(e.data),o.put(t,a)},this.checkOldPosts=function(e){return t(function(t,n){var s=e.filter(function(t){return i-o.get(t+"_min_date")<a});t(s)})},this.extractOldPosts=function(t){for(var e,n=o.get("oldPosts")||[],s=!0;s;)e=n.filter(function(t){var e=i-t.created_at;return e>0&&a>=e}),i-=a,e.length>0&&(s=!1);return this.updateOldPostsCount(t),e},this.loadOldPosts=function(e,o){function s(e){var s=t.defer(),i=d.getId("oldPosts",e);return n.load({id:i,count:c}).$promise.then(function(t){return!t||t.data&&t.data.length<1?void s.reject({status:304}):(t.min_date.twitter&&t.data.splice(0,1),d.storePosts("oldPosts",t,o),100>c?c+=10:null,void s.resolve())})["catch"](function(t){s.reject(t)}),s.promise}function i(){var e=t.defer();return d.checkOldPosts(o).then(function(t){t.length>0?s(t).then(i).then(function(){e.resolve()})["catch"](function(t){e.reject(t)}):e.resolve()}),e.promise}var a=t.defer(),d=this,c=r;return s(e).then(i).then(function(){100>r?r+=10:null,a.resolve()})["catch"](function(t){a.reject(t)}),a.promise},this.loadNewPosts=function(e){var o=t.defer();return _this=this,n.load({id:_this.getId("newPosts",e),count:70}).$promise.then(function(t){t.data&&t.data.length>0?(_this.storePosts("newPosts",t,e),o.resolve()):o.reject({status:304})},function(t){o.reject(t)}),o.promise},this.removeOldPosts=function(t,e){var n=Date.now(),o=t.filter(function(t){return n-t.created_at<a});return i=n-a,this.updateOldPostsCount(e),o},this.updateOldPostsCount=function(t){this.checkOldPosts(t).then(function(t){if(t.length>0)s.setPostsCount("oldPosts","");else{var e=o.get("oldPosts")||[],n=0;e.forEach(function(t){var e=i-t.created_at;e>0&&a>=e&&n++}),s.setPostsCount("oldPosts",0===n?"":n)}})},this.handleError=function(t,n){if(console.log(t),!t)return void s.setLoading("fail",n);if(401===t.status)e.go("settings");else if(429===t.status){s.setLoading("fail",n);var o=new Date(1e3*t.data.reset).toLocaleTimeString("en-GB").substring(0,5);s.setPostsCount("newPosts",o)}else s.setLoading("done",n)}}]);
