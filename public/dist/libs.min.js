...
angular.module("linkify",[]).filter("linkify",function(){"use strict";function t(t,e){if(t){var a=t.replace(/(?:https?\:\/\/)+(?![^\s]*?")([\w.,@?!^=%&amp;:\/~+#-]*[\w@?!^=%&amp;\/~+#-])?/gi,function(t){var e=document.createElement("div"),a=document.createElement("a");return a.href=t,a.target="_blank",a.innerHTML=t,e.appendChild(a),e.innerHTML});return a?("twitter"===e&&(a=a.replace(/(|\s)*@([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://twitter.com/$2" target="_blank">@$2</a>'),a=a.replace(/(^|\s)*#([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://twitter.com/search?q=%23$2" target="_blank">#$2</a>')),"github"===e&&(a=a.replace(/(|\s)*@(\w+)/g,'$1<a href="https://github.com/$2" target="_blank">@$2</a>')),"instagram"===e&&(a=a.replace(/(|\s)*@([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://instagram.com/$2" target="_blank">@$2</a>'),a=a.replace(/(^|\s)*#([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://instagram.com/explore/tags/$2" target="_blank">#$2</a>')),"weibo"===e&&(a=a.replace(/(|\s)*@([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="http://weibo.com/n/$2" target="_blank">@$2</a>'),a=a.replace(/(^|\s)*#([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)#/g,'$1<a href="http://huati.weibo.com/k/$2" target="_blank">#$2#</a>')),a):""}}return t}).directive("linkify",["$filter","$timeout",function(t,e){"use strict";return{restrict:"A",link:function(a,r,n){var u=n.linkify||"normal";e(function(){r.html(t("linkify")(r.html(),u))})}}}]);
