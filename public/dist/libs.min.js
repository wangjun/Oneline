...
angular.module("linkify",[]).filter("linkify",function(){"use strict";function t(t,e){if(t){var r=t.replace(/(?:https?\:\/\/)+(?![^\s]*?")([\w.,@?!^=%&amp;:\/~+#-]*[\w@?!^=%&amp;\/~+#-])?/gi,function(t){var e=document.createElement("div"),r=document.createElement("a");return r.href=t,r.target="_blank",r.innerHTML=t,e.appendChild(r),e.innerHTML});return r?("twitter"===e&&(r=r.replace(/(|\s)*@([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://twitter.com/$2" target="_blank">@$2</a>'),r=r.replace(/(^|\s)*#([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://twitter.com/search?q=%23$2" target="_blank">#$2</a>')),"github"===e&&(r=r.replace(/(|\s)*@(\w+)/g,'$1<a href="https://github.com/$2" target="_blank">@$2</a>')),"instagram"===e&&(r=r.replace(/(|\s)*@([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://instagram.com/$2" target="_blank">@$2</a>'),r=r.replace(/(^|\s)*#([\u00C0-\u1FFF\u2C00-\uD7FF\w]+)/g,'$1<a href="https://instagram.com/explore/tags/$2" target="_blank">#$2</a>')),r):""}}return t}).directive("linkify",["$filter","$timeout",function(t,e){"use strict";return{restrict:"A",link:function(r,a,n){var i=n.linkify||"normal";e(function(){a.html(t("linkify")(a.html(),i))})}}}]);
