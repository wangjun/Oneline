...
(function(){"use strict";angular.module("relativeDate",[]).value("now",null).value("relativeDateTranslations",{just_now:"just now",seconds_ago:"{{time}} seconds ago",a_minute_ago:"a minute ago",minutes_ago:"{{time}} minutes ago",an_hour_ago:"an hour ago",hours_ago:"{{time}} hours ago",a_day_ago:"yesterday",days_ago:"{{time}} days ago",a_week_ago:"a week ago",weeks_ago:"{{time}} weeks ago",a_month_ago:"a month ago",months_ago:"{{time}} months ago",a_year_ago:"a year ago",years_ago:"{{time}} years ago",over_a_year_ago:"over a year ago",seconds_from_now:"{{time}} seconds from now",a_minute_from_now:"a minute from now",minutes_from_now:"{{time}} minutes from now",an_hour_from_now:"an hour from now",hours_from_now:"{{time}} hours from now",a_day_from_now:"tomorrow",days_from_now:"{{time}} days from now",a_week_from_now:"a week from now",weeks_from_now:"{{time}} weeks from now",a_month_from_now:"a month from now",months_from_now:"{{time}} months from now",a_year_from_now:"a year from now",years_from_now:"{{time}} years from now",over_a_year_from_now:"over a year from now"}).filter("relativeDate",["$injector","now","relativeDateTranslations",function(e,o,a){var t,r;return t=e.has("$translate")?e.get("$translate"):{instant:function(e,o){return a[e].replace("{{time}}",o.time)}},r=function(e,o){return Math.round(Math.abs(e-o)/1e3)},function(e){var a,n,s,_,m,u,i,f,w;switch(u=o?o:new Date,new Date(e)||(e=new Date(e)),n=null,_=60,s=60*_,a=24*s,f=7*a,m=30*a,w=365*a,n=r(u,e),n>a&&f>n&&(e=new Date(e.getFullYear(),e.getMonth(),e.getDate(),0,0,0),n=r(u,e)),i=function(o,a){var r;return r="just_now"===o?o:u>=e?""+o+"_ago":""+o+"_from_now",t.instant(r,{time:a})},!1){case!(7>n):return i("just_now");case!(_>n):return i("seconds",n);case!(2*_>n):return i("a_minute");case!(s>n):return i("minutes",Math.floor(n/_));case 1!==Math.floor(n/s):return i("an_hour");case!(a>n):return i("hours",Math.floor(n/s));case!(2*a>n):return i("a_day");case!(f>n):return i("days",Math.floor(n/a));case 1!==Math.floor(n/f):return i("a_week");case!(m>n):return i("weeks",Math.floor(n/f));case 1!==Math.floor(n/m):return i("a_month");case!(w>n):return i("months",Math.floor(n/m));case 1!==Math.floor(n/w):return i("a_year");default:return i("over_a_year")}}}]).directive("relativeDate",["$timeout","$filter",function(e,o){return function(a,t,r){function n(){t.text(o("relativeDate")(m)),6e4>u&&new Date-Date.parse(m)>6e4&&(u=6e4)}function s(){_=e(function(){n(),s()},u)}var _,m=r.relativeDate,u=1e3;t.bind("$destroy",function(){e.cancel(_)}),n(),s()}}])}).call(this);
